...
public class sellerregisteractivity<DatabaseRefernce, string> extends AppCompatActivity

{

    private Button CreateAccountButton;
    private EditText InputFirstname, InputLastname,  InputUserName, InputEmailId, InputPhoneNumber, InputPassword;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_sellerregisteractivity);
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                    ...
                    RootRef.child("users").child(phone).updateChildren(userdataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task)
                                {
                                    ...
                                    {
                                        Toast.makeText(sellerregisteractivity.this, "congrats your account has been created", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                ...
                else
                {
                    ...
                    Intent intent = new Intent(sellerregisteractivity.this, WelcomeActivity.class);
                    startActivity(intent);
